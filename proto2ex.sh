...
rotoc --elixir_out=plugins=grpc:./lib -I./priv/data-plane-api/ -I./priv/xds/ -I./priv/protoc-gen-validate/ -I./priv/grpc-proto/ -I./priv/googleapis/ ./priv/data-plane-api/envoy/config/rbac/v3/rbac.proto
