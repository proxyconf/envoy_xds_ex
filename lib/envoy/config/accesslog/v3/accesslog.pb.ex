defmodule Envoy.Config.Accesslog.V3.ComparisonFilter.Op do
  use Protobuf,
    enum: true,
    full_name: "envoy.config.accesslog.v3.ComparisonFilter.Op",
...
defmodule Envoy.Config.Accesslog.V3.GrpcStatusFilter.Status do
  use Protobuf,
    enum: true,
    full_name: "envoy.config.accesslog.v3.GrpcStatusFilter.Status",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.AccessLog do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.AccessLog",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.AccessLogFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.AccessLogFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.ComparisonFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.ComparisonFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.StatusCodeFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.StatusCodeFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.DurationFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.DurationFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.NotHealthCheckFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.NotHealthCheckFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
end
...
defmodule Envoy.Config.Accesslog.V3.TraceableFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.TraceableFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
end
...
defmodule Envoy.Config.Accesslog.V3.RuntimeFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.RuntimeFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.AndFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.AndFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.OrFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.OrFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.HeaderFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.HeaderFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.ResponseFlagFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.ResponseFlagFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.GrpcStatusFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.GrpcStatusFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.MetadataFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.MetadataFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.LogTypeFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.LogTypeFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Accesslog.V3.ExtensionFilter do
  ...
  use Protobuf,
    full_name: "envoy.config.accesslog.v3.ExtensionFilter",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
