...
defmodule Envoy.Config.Filter.Network.KafkaBroker.V2alpha1.IdBasedBrokerRewriteSpec do
  ...
  use Protobuf,
    full_name: "envoy.config.filter.network.kafka_broker.v2alpha1.IdBasedBrokerRewriteSpec",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Filter.Network.KafkaBroker.V2alpha1.IdBasedBrokerRewriteRule do
  ...
  use Protobuf,
    full_name: "envoy.config.filter.network.kafka_broker.v2alpha1.IdBasedBrokerRewriteRule",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
