...
defmodule Envoy.Config.Filter.Network.HttpConnectionManager.V2.HttpConnectionManager.ServerHeaderTransformation do
  use Protobuf,
    enum: true,
    full_name:
      "envoy.config.filter.network.http_connection_manager.v2.HttpConnectionManager.ServerHeaderTransformation",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Config.Filter.Network.HttpConnectionManager.V2.HttpConnectionManager.ForwardClientCertDetails do
  ...
  use Protobuf,
    enum: true,
    full_name:
      "envoy.config.filter.network.http_connection_manager.v2.HttpConnectionManager.ForwardClientCertDetails",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
