defmodule Envoy.Extensions.LoadBalancingPolicies.Subset.V3.Subset.LbSubsetFallbackPolicy do
  ...
  use Protobuf,
    enum: true,
    full_name: "envoy.extensions.load_balancing_policies.subset.v3.Subset.LbSubsetFallbackPolicy",
...
defmodule Envoy.Extensions.LoadBalancingPolicies.Subset.V3.Subset.LbSubsetSelector do
  ...
  use Protobuf,
    full_name: "envoy.extensions.load_balancing_policies.subset.v3.Subset.LbSubsetSelector",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
...
defmodule Envoy.Extensions.LoadBalancingPolicies.Subset.V3.Subset do
  ...
  use Protobuf,
    full_name: "envoy.extensions.load_balancing_policies.subset.v3.Subset",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
