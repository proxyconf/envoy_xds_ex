defmodule Envoy.Extensions.LoadBalancingPolicies.RingHash.V3.RingHash.HashFunction do
  ...
  use Protobuf,
    enum: true,
    full_name: "envoy.extensions.load_balancing_policies.ring_hash.v3.RingHash.HashFunction",
...
defmodule Envoy.Extensions.LoadBalancingPolicies.RingHash.V3.RingHash do
  ...
  use Protobuf,
    full_name: "envoy.extensions.load_balancing_policies.ring_hash.v3.RingHash",
    protoc_gen_elixir_version: "0.16.0",
    syntax: :proto3
